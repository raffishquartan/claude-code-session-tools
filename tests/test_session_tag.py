...
def test_encode_path_replaces_slashes_with_dashes():
    assert session_tag.encode_path("/home/chris") == "-home-chris"


def test_encode_path_replaces_dots_with_dashes():
    # /home/chris/.claude -> -home-chris--claude (each non-alnum char → -)
    assert session_tag.encode_path("/home/chris/.claude") == "-home-chris--claude"


def test_encode_path_known_oneshot_path():
    encoded = session_tag.encode_path("/mnt/c/Users/cfoge/OneDrive/claude/oneshot")
