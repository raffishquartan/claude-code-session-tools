...
def test_transcript_dir_encoding_simple():
    # /home/chris/repos/my-project -> -home-chris-repos-my-project
    result = sessions.transcript_dir_for_project(Path("/home/chris/repos/my-project"))
...
def test_transcript_dir_encoding_with_dots():
    ...
    result = sessions.transcript_dir_for_project(Path("/home/chris/.local/share"))
